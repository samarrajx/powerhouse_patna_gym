...
export default function Members() {
  ...
  const downloadSample = () => {
    const headers = ['name','phone','phone_alt','roll_no','father_name','address','date_of_joining','body_type','batch_name','membership_plan','membership_expiry','fees_status','notes'];
    const examples = [
      ['Rahul Sharma','9876543210','9876543211','101','Ramesh Sharma','12 MG Road Patna','2026-01-15','normal','Morning','Standard','2027-01-15','paid','Morning batch preferred'],
      ['Priya Singh','9123456780','','102','Vijay Singh','45 Park Colony Patna','2026-02-01','skinny','Evening','Monthly','2026-08-01','paid',''],
      ['Amit Kumar','8765432109','','103','Suresh Kumar','88 Gandhi Nagar Patna','2026-03-01','fatty','Evening','Quarterly','2026-06-01','pending','Evening batch'],
    ];
